  ...
  <div className="container p-6 mx-auto">
      <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                  <a href="#">
                      <img className="w-24 h-full md:w-32 md:h-full lg:w-40 lg:h-full" src={logo} alt="" />
                  </a>
                 

                  <p className="max-w-sm mt-2 text-gray-500">Join 31,000+ others and never miss out on new tips, tutorials, and more.</p>
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div>
                      ...
                      <a href="#" className="block mt-2 text-sm text-gray-600 hover:underline">Return Track</a>
                  </div>
      ...
      <div>
          <p className="text-center">© ReturnTrack 2024 - All rights reserved</p>
      </div>
  </div>
</footer>
